...
-- CreateIndex
CREATE UNIQUE INDEX "_UserSeenMessage_AB_unique" ON "_UserSeenMessage"("A", "B");

-- CreateIndex
CREATE INDEX "_UserSeenMessage_B_index" ON "_UserSeenMessage"("B");
...
-- AddForeignKey
ALTER TABLE "_UserSeenMessage" ADD CONSTRAINT "_UserSeenMessage_A_fkey" FOREIGN KEY ("A") REFERENCES "Message"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UserSeenMessage" ADD CONSTRAINT "_UserSeenMessage_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
